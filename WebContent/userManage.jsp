		...
		<div class="head" style="height:125px;padding-bottom:0px;">
			...
			<div style="width:50%;float:left;">
			 ...
			 <div class="menu">
				...
				<a class="x select" href="userManage.html">用户管理</a>
			</div>
		</div>
	</div>
<div class="body">
<div class="body_bg">
	...
	<div>
		<ul class="table title" style="margin-left:30px; width:90%;">
			...
			<li class="t4" style="width:430px;">邮箱</li>
		...
		<ul class="table interleaved_0" style="margin-left:30px;width:90%;">
				...
				<li class="t3" style="width:150px; "><span class='green'>password1</span></li>
				<li class="t4" style="width:430px;">59597459@qq.com</li>
